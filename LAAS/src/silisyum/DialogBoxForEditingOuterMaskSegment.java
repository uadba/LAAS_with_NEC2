...
public class DialogBoxForEditingOuterMaskSegment extends JDialog {
	 ...
	 * @param userInterface 
	 */
	public DialogBoxForEditingOuterMaskSegment(UserInterface _frame, String _title, boolean _modal, Mask _mask) {
